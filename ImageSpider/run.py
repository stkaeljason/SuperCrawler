...
def run(args):
    enc_password = '#PWD_INSTAGRAM_BROWSER:10:1594691972:AWlQALWH2qqSoBX+YKdqHUaYxm/CC5V/LcuoVvte08Qdv5JBSPYq4wCS8oWCRj/d/08XxADUj+hl4lhPAIjTMx2HG4rBGz5VGt3wbBuygX4wp8Gz+oEE7MA56xaautgGIt9YqT/stmBuPm1J'
    execute_cmd = None
    if 'ins' in args.site:
