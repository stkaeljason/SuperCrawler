...
def run(args):
    enc_password = '#PWD_INSTAGRAM_BROWSER:10:1591150862:AUtQAD3YbZNz2vPCA6zWOEQehege0Vr9PxhIeDebGtUSBewG6MCC6kc/mzbvAafDu+kTU10fXKolEn/mrwfcSsSbaA+7lXH8ToOcFlsyPS+lW1hwpw74Tyun+TpLmORdI0sM97kEtZyexoKo'
    execute_cmd = None
    if 'ins' in args.site:
